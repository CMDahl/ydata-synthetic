...
def CB_timeGAN(synth,alpha_true, T=1000,warm = 1000,seq_len=150,replications=2,resamples=100,
...
CB_timeGAN(gan_args,alpha_true=0.5,replications=1000,resamples=10000)
